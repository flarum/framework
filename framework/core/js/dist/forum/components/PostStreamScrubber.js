"use strict";
(self["webpackChunkflarum_core"] = self["webpackChunkflarum_core"] || []).push([["forum/components/PostStreamScrubber"],{
...
/* harmony import */ var _common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../common/utils/formatNumber */ "./src/common/utils/formatNumber.ts");
 ...
 * - `className`
 */
class PostStreamScrubber extends _common_Component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  oninit(vnode) {
    super.oninit(vnode);
    this.stream = this.attrs.stream;
    this.handlers = {};
    this.scrollListener = new _common_utils_ScrollListener__WEBPACK_IMPORTED_MODULE_3__["default"](this.updateScrubberValues.bind(this, {
      fromScroll: true,
  ...
  view() {
    ...
    const viewing = _forum_app__WEBPACK_IMPORTED_MODULE_0__["default"].translator.trans('core.forum.post_scrubber.viewing_text', {
      count,
      index: m("span", {
      ...
      }, (0,_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_2__["default"])(count))
    });
    ...
    }, viewing, " ", m(_common_components_Icon__WEBPACK_IMPORTED_MODULE_4__["default"], {
      name: 'fas fa-sort'
    })), m("div", {
    ...
    }), " ", _forum_app__WEBPACK_IMPORTED_MODULE_0__["default"].translator.trans('core.forum.post_scrubber.original_post_link')), m("div", {
    ...
    }, _forum_app__WEBPACK_IMPORTED_MODULE_0__["default"].translator.trans('core.forum.post_scrubber.unread_text', {
      count: unreadCount
    }))), m("a", {
    ...
    }), " ", _forum_app__WEBPACK_IMPORTED_MODULE_0__["default"].translator.trans('core.forum.post_scrubber.now_link')))));
  }
  onupdate(vnode) {
  ...
  updateScrubberValues(options) {
    ...
    const $scrubber = this.$();
    $scrubber.find('.Scrubber-index').text((0,_common_utils_formatNumber__WEBPACK_IMPORTED_MODULE_2__["default"])(this.stream.sanitizeIndex(Math.max(1, index))));
...
flarum.reg.add('core', 'forum/components/PostStreamScrubber', PostStreamScrubber);
