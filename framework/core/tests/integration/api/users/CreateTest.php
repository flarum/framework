...
class CreateTest extends TestCase
{
    ...
    public function can_create_user_with_valid_avatar_uri()
    {
        ...
        $regTokens[] = RegistrationToken::generate('flarum', '1', [
            ...
            'is_email_confirmed' => 1,
            'avatar_url' =>  'https://raw.githubusercontent.com/flarum/framework/main/framework/core/tests/integration/fixtures/assets/avatar.png'
        ], []);
        ...
        $regTokens[] = RegistrationToken::generate('flarum', '2', [
            ...
            'is_email_confirmed' => 1,
            'avatar_url' =>  'https://raw.githubusercontent.com/flarum/framework/main/framework/core/tests/integration/fixtures/assets/avatar.jpg'
        ], []);
        ...
        $regTokens[] = RegistrationToken::generate('flarum', '3', [
            ...
            'is_email_confirmed' => 1,
            'avatar_url' =>  'https://raw.githubusercontent.com/flarum/framework/main/framework/core/tests/integration/fixtures/assets/avatar.gif'
        ], []);
