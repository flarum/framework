...
class XsltPolyfillTest extends TestCase
{
    ...
    #[Test]
    public function head_emits_xslt_polyfill_loader(): void
    {
    ...
    #[Test]
    public function head_polyfill_loader_is_short(): void
    {
        $body = $this->fetchForumHtml();
        $head = $this->extractHead($body);
    ...
    #[Test]
    public function head_polyfill_loader_url_is_safely_escaped(): void
    {
