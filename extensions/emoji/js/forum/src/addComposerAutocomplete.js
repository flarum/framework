            ...
            return (
              <button className={'PostPreview'}
                ...
                <span className="PostPreview-content">
                  <img alt={code} class="emoji" draggable="false" src={'//twemoji.maxcdn.com/36x36/' + emoji_map[key] + '.png'}></img>
                  {key}
                </span>
              </button>
            );
