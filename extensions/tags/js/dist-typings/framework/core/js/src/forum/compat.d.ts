...
declare const _default: {
    ...
    'models/Discussion': typeof import("flarum/common/models/Discussion").default;
    ...
    'utils/DiscussionControls': {
        controls(discussion: import("flarum/common/models/Discussion").default, context: import("../common/Component").default<any, any>): import("../common/utils/ItemList").default<import("mithril").Children>;
        userControls(discussion: import("flarum/common/models/Discussion").default, context: import("../common/Component").default<any, any>): import("../common/utils/ItemList").default<import("mithril").Children>;
        moderationControls(discussion: import("flarum/common/models/Discussion").default): import("../common/utils/ItemList").default<import("mithril").Children>;
        destructiveControls(discussion: import("flarum/common/models/Discussion").default): import("../common/utils/ItemList").default<import("mithril").Children>;
