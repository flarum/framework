    ...
    public function setUp(): void
    {
        ...
        $this->prepareDatabase([
            ...
            'gdpr_erasure' => [
                ...
                ['id' => 2, 'user_id' => 2, 'verification_token' => null, 'status' => 'user_confirmed', 'created_at' => Carbon::now()->subDays(1), 'user_confirmed_at' => Carbon::now()->subDays(1), 'confirmation_ip' => '5.6.7.8'],
                // Old confirmed request without IP — unaffected
                ['id' => 3, 'user_id' => 2, 'verification_token' => null, 'status' => 'user_confirmed', 'created_at' => Carbon::now()->subDays(91), 'user_confirmed_at' => Carbon::now()->subDays(91), 'confirmation_ip' => null],
            ],
        ]);
    }
