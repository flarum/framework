...
System.register('flarum/embed/main', ['flarum/extend', 'flarum/app', 'flarum/components/Composer', 'flarum/components/ModalManager', 'flarum/components/AlertManager', 'flarum/embed/components/DiscussionPage'], function (_export) {
  'use strict';

  var override, app, Composer, ModalManager, AlertManager, DiscussionPage;
  return {
    ...
    execute: function () {
      ...
      app.initializers.add('boot', function () {
...
System.register('flarum/embed/components/DiscussionPage', ['flarum/Component', 'flarum/components/PostStream'], function (_export) {
  'use strict';

  var Component, PostStream, DiscussionPage;
  ...
  return {
    ...
    execute: function () {
      DiscussionPage = (function (_Component) {
        _inherits(DiscussionPage, _Component);
        ...
        function DiscussionPage() {
          ...
          _get(Object.getPrototypeOf(DiscussionPage.prototype), 'constructor', this).apply(this, args);
           ...
           * @type {Discussion}
           */
          var discussion = this.discussion = app.preloadedDocument();
