...
System.register('flarum/embed/main', ['flarum/extend', 'flarum/app', 'flarum/components/Composer', 'flarum/components/ModalManager', 'flarum/components/AlertManager', 'flarum/utils/mapRoutes', 'flarum/utils/Pane', 'flarum/utils/Drawer', 'flarum/embed/components/DiscussionPage'], function (_export) {
  'use strict';

  var override, app, Composer, ModalManager, AlertManager, mapRoutes, Pane, Drawer, DiscussionPage;
  return {
    ...
    execute: function () {
      ...
      app.initializers.boot.content = function (app) {
