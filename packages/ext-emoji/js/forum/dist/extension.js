...
;
System.register('flarum/emoji/addComposerAutocomplete', ['flarum/extend', 'flarum/components/ComposerBody', 'flarum/emoji/components/AutocompleteDropdown'], function (_export) {
        ...
        if (emojiStart) {
          (function () {
            ...
            var makeSuggestion = function makeSuggestion(key) {
              ...
              return m(
                ...
                m(
                  ...
                  m('img', { alt: code, 'class': 'emoji', draggable: 'false', src: '//twemoji.maxcdn.com/36x36/' + emoji_map[key] + '.png' }),
                  key
                )
              );
            };
            ...
            var buildSuggestions = function buildSuggestions() {
              ...
              for (var i = 0, maxSuggestions = 7; i < emoji_keys.length && maxSuggestions > 0; i++) {
                if (regTyped.test(emoji_keys[i])) {
                  --maxSuggestions;
                  similarEmoji.push(emoji_keys[i]);
                }
              }
...
System.register('flarum/emoji/components/AutocompleteDropdown', ['flarum/Component'], function (_export) {
  'use strict';
...
System.register('flarum/emoji/main', ['flarum/extend', 'flarum/app', 'flarum/models/Post', 'flarum/emoji/addComposerAutocomplete'], function (_export) {
  'use strict';
