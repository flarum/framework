...
### Fixed
* (mentions) missed post mentions UI changes with lazy loading
* (mentions) cannot use newly introduced mentionables extender
* (mentions) missing slug from post mention links
